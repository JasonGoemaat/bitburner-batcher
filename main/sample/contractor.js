import { getFilePath, getNsDataThroughFile, disableLogs, scanAllServers } from '/sample/helpers.js'
...
export async function main(ns) {
    ...
    ns.run(getFilePath('/sample/run-with-delay.js'), 1, scriptSolver, 1, JSON.stringify(contractsDb));
}