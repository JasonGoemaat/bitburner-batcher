...
const SAMPLE_SERVER = { "contracts": [], "cpuCores": 1, "ftpPortOpen": true, "hasAdminRights": true,
	"hostname": "sample-host", "httpPortOpen": false, "ip": "127.0.0.1", "isConnectedTo": false,
	"maxRam": 32, "messages": [], "organizationName": "Sample Organization", "programs": [], "ramUsed": 0,
	"runningScripts": [], "scripts": [], "serversOnNetwork": [], "smtpPortOpen": false, "sqlPortOpen": false,
	"sshPortOpen": true, "textFiles": [], "purchasedByPlayer": false, "backdoorInstalled": false,
	"baseDifficulty": 20, "hackDifficulty": 29, "minDifficulty": 7, "moneyAvailable": 123456789,
	"moneyMax": 67500000, "numOpenPortsRequired": 2, "openPortCount": 2, "requiredHackingSkill": 100, "serverGrowth": 35
}
...
/**
 * Resulting object for scan
 * @typedef {Object<string, Server>} ServerMap
 */
...
export function scanNetwork(ns) {
	...
	queued[currentHostname] = true
	queue.push(currentHostname)
	while (queue.length) {
...
export async function main(ns) {
	...
	const remoteFiles = await ns.ls('home', 'remote/')
